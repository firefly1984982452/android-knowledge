...
public class SMSUtil {
    ...
    public static final String API_KEY = "20803210d5e870210c61e133ecf67194";

    public static void main(String[] args) throws IOException, URISyntaxException {

        //修改为您的apikey.apikey可在官网（http://www.yuanpian.com)登录后获取
        String apikey = "20803210d5e870210c61e133ecf67194";

        //修改为您要发送的手机号
        String mobile = "15111423714";
        ...
        String text = "【思泰旭嘉】您的验证码是abc123456";
        //发短信调用示例
...
//            + URLEncoder.encode("思泰旭嘉",ENCODING);
//        //模板发送的调用示例
...
//        System.out.println(SMSUtil.tplSendSms(apikey, tpl_id, tpl_value, mobile));
    ...
    public static String sendSms(String text, String mobile) throws IOException {
        Map<String, String> params = new HashMap<String, String>();
        params.put("apikey", SMSUtil.API_KEY);
